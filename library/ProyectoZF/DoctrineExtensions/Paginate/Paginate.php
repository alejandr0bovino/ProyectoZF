...
namespace ProyectoZF\DoctrineExtensions\Paginate;
...
class Paginate
{
    ...
    static public function createCountQuery(Query $query)
    {
        ...
        $countQuery->setHint(Query::HINT_CUSTOM_TREE_WALKERS, array('ProyectoZF\DoctrineExtensions\Paginate\CountWalker'));
    ...
    static public function createLimitSubQuery(Query $query, $offset, $itemCountPerPage)
    {
        ...
        $subQuery->setHint(Query::HINT_CUSTOM_TREE_WALKERS, array('ProyectoZF\DoctrineExtensions\Paginate\LimitSubqueryWalker'))
    ...
    static public function createWhereInQuery(Query $query, array $ids, $namespace = 'pgid')
    {
        ...
        $whereInQuery->setHint(Query::HINT_CUSTOM_TREE_WALKERS, array('ProyectoZF\DoctrineExtensions\Paginate\WhereInWalker'));
